...
mainctr.controller('ManagementCtrl', function($scope, $ionicBackdrop,$ionicPopup, $http) {
	$scope.rowHeight=150;
	})	
.controller('ManagementScheduleCtrl', function ($scope, $ionicBackdrop,$ionicPopup, $http, $ionicScrollDelegate) {
        ...
        //事件上报的controller
        .controller('ManagementReportCtrl', function($scope,$rootScope,$ionicBackdrop,$ionicPopup,$cordovaDevice,$cordovaCapture,$ionicLoading,$http,$ionicActionSheet,$cordovaCamera,$cordovaImagePicker,$ionicLoading, Camera, Upyun,$timeout) 
        {
						$scope.image = '';
