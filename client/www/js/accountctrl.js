...
accountctr.controller('AccountCtrl', function($scope,$rootScope,$state, $ionicBackdrop,$ionicPopup, $http,$ionicModal) {
  ...
  $scope.outRegister= function(){
    ...
    // 生成模态窗口
        ...
        .controller('AccountLoginCtrl', function($scope,$rootScope,$ionicBackdrop,$ionicPopup,$cordovaDevice,$cordovaCapture,$ionicLoading,$http,$ionicActionSheet,$cordovaCamera,$cordovaImagePicker,$ionicLoading, Camera, Upyun,$timeout) 
        {
						$scope.image = '';
